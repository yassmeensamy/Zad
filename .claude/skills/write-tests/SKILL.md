---
name: write-tests
description: Write Patrol E2E integration tests following project conventions, Page Object Model, and best practices. Use when the user asks to write, add, or implement a new E2E test.
argument-hint: "test ID from E2E_TEST_TRACKER.json (e.g. T2, T5) or a flow description"
---
